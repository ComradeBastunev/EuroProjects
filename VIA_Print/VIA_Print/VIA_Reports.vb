...
Public Interface IVIA_Reports_Client
    Function PrintOrder(aConnStr As String, aService As Integer, aOrder_No As Long, aSplit As Integer) As Integer

    Function PrintBodyCheck(aConnStr As String, aService As Integer, aOrder_No As Long, aSplit As Integer) As Integer
...
<ClassInterface(ClassInterfaceType.None)> Public Class VIA_Reports
    Implements IVIA_Reports_Client

    Function PrintOrder(aConnStr As String, aService As Integer, aOrder_No As Long, aSplit As Integer) As Integer Implements IVIA_Reports_Client.PrintOrder
        PrintOrder = 0
    ...
    Function PrintBodyCheck(aConnStr As String, aService As Integer, aOrder_No As Long, aSplit As Integer) As Integer Implements IVIA_Reports_Client.PrintBodyCheck
        PrintBodyCheck = 0
        ...
        PrintBodyCheck = 1
        Return PrintBodyCheck
    End Function


    Function PrintInvoice(aConnStr As String, aInvNo As Double) As Integer Implements IVIA_Reports_Client.PrintInvoice
        PrintInvoice = 0
        gInv_No = aInvNo
        gConnStr = aConnStr
    ...
    Function PreviewInvoice(aConnStr As String, aInvNo As Double) As Integer Implements IVIA_Reports_Client.PreviewInvoice
        PreviewInvoice = 0
        gInv_No = aInvNo
        gConnStr = aConnStr
        Dim DataSet11 As New DataSet1
    ...
    Function PrintProforma(aConnStr As String, aService As Integer, aOrder_No As Long, aSplit As Integer, aCurr As Integer, aRateType As Integer, aRateDate As DateTime, aShowAll As Integer, aBankAcc As Integer, aShowCodes As Integer, aOrder_Type As Integer) As Integer Implements IVIA_Reports_Client.PrintProforma
        PrintProforma = 0
        gOrderNo = aOrder_No
        gService = aService
        gSplit = aSplit

...
Module Module1
    Public MyEntitiesConnection As String
    Public WebPass As String
    ...
    Function EntityConnBuild(ByVal aConnString As String) As String
        ...
        sqlBuilder.ConnectionString = aConnString
        ...
        entityBuilder.Metadata = "res://*/ModelMVB.csdl|res://*/ModelMVB.ssdl|res://*/ModelMVB.msl"
        EntityConnBuild = entityBuilder.ToString
        MyEntitiesConnection = EntityConnBuild
        Return EntityConnBuild
    End Function

...
Public Interface IPolihronov_Reports_Client
...
<ClassInterface(ClassInterfaceType.None)> Public Class Polihronov_Reports
    Implements IPolihronov_Reports_Client

    Function PrintOrder(aConnStr As String, aService As Integer, aOrder_No As Long, aSplit As Integer) As Integer Implements IPolihronov_Reports_Client.PrintOrder
        PrintOrder = 0
    ...
    Function PrintCheckList(aConnStr As String, aService As Integer, aOrder_No As Long, aSplit As Integer) As Integer Implements IPolihronov_Reports_Client.PrintCheckList
        PrintCheckList = 0
        gOrderNo = aOrder_No
        gService = aService
        gSplit = aSplit
    ...
    Function PrintInvoice(aConnStr As String, aInvNo As Double) As Integer Implements IPolihronov_Reports_Client.PrintInvoice
        PrintInvoice = 0
        gInv_No = aInvNo
        gConnStr = aConnStr
    ...
    Function PreviewInvoice(aConnStr As String, aInvNo As Double) As Integer Implements IPolihronov_Reports_Client.PreviewInvoice
        PreviewInvoice = 0
        gInv_No = aInvNo
        gConnStr = aConnStr
        Dim DataSet11 As New DataSet1
    ...
    Function PrintProforma(aConnStr As String, aService As Integer, aOrder_No As Long, aSplit As Integer, aCurr As Integer, aRateType As Integer, aRateDate As DateTime, aShowAll As Integer, aBankAcc As Integer, aShowCodes As Integer, aOrder_Type As Integer) As Integer Implements IPolihronov_Reports_Client.PrintProforma
        PrintProforma = 0
        gOrderNo = aOrder_No
        gService = aService
        gSplit = aSplit

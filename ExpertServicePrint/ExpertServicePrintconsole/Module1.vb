Module Module1
    ...
    Sub Main()
        ...
        Dim sp = New ExpertServicePrint.ExpertService_Reports
        If clArgs(1) = "1" Then
            sp.PreviewInvoice(clArgs(2), CDbl(clArgs(3)))
        ElseIf clArgs(1) = "2" Then
            sp.PrintInvoice(clArgs(2), CDbl(clArgs(3)), CDbl(clArgs(4)))
        ...
        ElseIf clArgs(1) = "6" Then
            sp.PrintCombinedOrder(clArgs(2), CDbl(clArgs(3)), CDbl(clArgs(4)), CDbl(clArgs(5)))

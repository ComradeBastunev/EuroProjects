Public Class Order_Print
    ...
    Private Sub Order_Print_BeforePrint(sender As Object, e As Drawing.Printing.PrintEventArgs) Handles MyBase.BeforePrint
        ...
        XrBarCode1.Text = "2" & gOrderNo.ToString("00000000000")
        ...
        If DataSet11.zOrder_Complaints.Count > 0 AndAlso (Not DataSet11.zOrder_Complaints.First.IsMain_Model_NameNull AndAlso DataSet11.zOrder_Complaints.First.Main_Model_Name.ToUpper.Contains("LEXUS")) Then

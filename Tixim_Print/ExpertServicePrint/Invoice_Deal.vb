...
Public Class Invoice_Deal
    ...
    Private Sub Invoice_Deal_BeforePrint(sender As Object, e As System.Drawing.Printing.PrintEventArgs) Handles MyBase.BeforePrint
        ...
        Dim dt = Get_InvoiceTableAdapter.GetData(CDec(gInv_No))
        ...
        ZInvoice_Rows_PrintTableAdapter1.Fill(DataSet11.zInvoice_Rows_Print, CDec(gInv_No), CInt(IIf(CInt(ir.Service) = 0 Or CInt(ir.Service) = 8, 2, 0)), CBool(ShortPrint.Value), CBool(ShowPArts.Value))
    End Sub
    ...
    Private Sub Invoice_Deal_FillEmptySpace(sender As Object, e As DevExpress.XtraReports.UI.BandEventArgs) Handles MyBase.FillEmptySpace
        ...
        XRlabelFiller.Borders = BorderSide.Left Or BorderSide.Right

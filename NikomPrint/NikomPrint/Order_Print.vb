Public Class Order_Print
    ...
    Private Sub Order_Print_BeforePrint(sender As Object, e As Drawing.Printing.PrintEventArgs) Handles MyBase.BeforePrint
        ...
        If DataSet11.zOrder_Jobs.Count > 0 AndAlso ((Not DataSet11.zOrder_Jobs.First.IsMake_NameNull AndAlso DataSet11.zOrder_Jobs.First.Make_Name.ToUpper.Contains("LEXUS")) OrElse (Not DataSet11.zOrder_Jobs.First.IsMain_Model_NameNull AndAlso DataSet11.zOrder_Jobs.First.Main_Model_Name.ToUpper.Contains("LEXUS"))) Then
            XrPictureBoxToyota.Visible = False
            XrPictureBoxToyota1.Visible = False
            XrPictureBoxLexus.Visible = True
            XrPictureBoxLexus1.Visible = True
        End If

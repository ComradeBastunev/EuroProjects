...
Public Class FormPrintOrder
    ...
    Private Sub SimpleButtonbodyCheck_Click(sender As Object, e As EventArgs) Handles SimpleButtonbodyCheck.Click
        ...
        With SpreadsheetControl1
            .LoadDocument("ProtocolBodyCheck.xlsx")
    ...
    Private Sub SimpleButtonPrint_Click(sender As Object, e As EventArgs) Handles SimpleButtonPrint.Click
        ...
        If CheckEditPartsReq.Checked Then SimpleButtonPartReq.PerformClick()
        If CheckEditGDPR.Checked Then SimpleButtonGDPR.PerformClick()

    End Sub

    Private Sub SimpleButton1_Click(sender As Object, e As EventArgs) Handles SimpleButtonPartReq.Click
        Using ReportOrder As New PartsReq
            gForClient = True
            Using printTool As New ReportPrintTool(ReportOrder)
                ' Invoke the Ribbon Print Preview form modally, 
                ' and load the report document into it.
    ...
    Private Sub SimpleButtonGDPR_Click(sender As Object, e As EventArgs) Handles SimpleButtonGDPR.Click
        Using ReportOrder As New GDPRToyota
            gForClient = True
            Using printTool As New ReportPrintTool(ReportOrder)
                ' Invoke the Ribbon Print Preview form modally, 
                ' and load the report document into it.
